...
export const metadata = {
  ...
  description:
    "Politique de confidentialité et protection des données personnelles — Parenthèse.",
};
          ...
          <div className="max-w-3xl mx-auto flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                Faustine Pichon, micro-entreprise Parenthèse —
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                Aucune donnée sensible (santé, bancaire, etc.) n&apos;est collectée
                via ce formulaire.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                ...
                répondre à vos demandes de contact ou de réservation. Elles ne
                sont jamais cédées, vendues ou transmises à des tiers à des fins
                commerciales.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                ...
                traitement de votre demande, et au maximum 3 ans après le
                dernier contact.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                ...
                du site peuvent être utilisés, sans collecte de données
                personnelles.
              </p>
            </div>
