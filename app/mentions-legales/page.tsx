          ...
          <div className="max-w-3xl mx-auto flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="text-muted-foreground text-sm leading-relaxed flex flex-col gap-1">
                ...
                <p>
                  ...
                  Accompagnante périnatale — soins bien-être à domicile
                </p>
                <p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                ...
                structure) est la propriété exclusive de Parenthèse, sauf
                mention contraire. Toute reproduction, distribution ou
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                Les informations présentées sur ce site sont données à titre
                indicatif et ne constituent pas un avis médical. Parenthèse ne
                saurait être tenu responsable des dommages directs ou indirects
                résultant de l&apos;utilisation de ce site. Les soins proposés
            ...
            <div id="cookies" className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  ...
                  ne collectent aucune donnée personnelle identifiable et ne
                  peuvent pas être désactivés. Ils incluent notamment la
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Avec votre accord, nous utilisons Google Analytics (Google
                  LLC) pour mesurer l&apos;audience du site de façon anonyme :
                  pages visitées, durée des sessions, provenance du trafic. Ces
                  données sont agrégées et ne permettent pas de vous identifier
                  personnellement. Google peut transférer ces données vers ses
                  serveurs aux États-Unis.
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Vous pouvez retirer votre consentement à tout moment en
                  effaçant les cookies de votre navigateur via ses paramètres.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Les polices utilisées sur ce site (Dancing Script, Cormorant
                  Garamond) sont hébergées directement sur nos serveurs via la
                  fonctionnalité d&apos;auto-hébergement de Next.js. Aucune
                  requête n&apos;est envoyée à Google lors de votre visite.
                </p>
              </div>
            </div>
